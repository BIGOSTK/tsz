/*
9.28-10.08 礼惠国庆 大牌狂欢购
============Quantumultx===============
[task_local]
#9.28-10.08 礼惠国庆 大牌狂欢购
45 2,22 * * * jd_opencard39.js, tag=9.28-10.08 礼惠国庆 大牌狂欢购, enabled=true

================Loon==============
[Script]
cron "45 2,22 * * *" script-path=jd_opencard39.js,tag=9.28-10.08 礼惠国庆 大牌狂欢购

===============Surge=================
9.28-10.08 礼惠国庆 大牌狂欢购 = type=cron,cronexp="45 2,22 * * *",wake-system=1,timeout=3600,script-path=jd_opencard39.js

============小火箭=========
9.28-10.08 礼惠国庆 大牌狂欢购 = type=cron,script-path=jd_opencard39.js, cronexpr="45 2,22 * * *", timeout=3600, enable=true
*/
const $ = new Env('9.28-10.08 礼惠国庆 大牌狂欢购');
...
!(async () => {
    ...
    $.shareUuid = '51f083f3e33c46c3870b3b9410f55415'
